...
```bash
kubectl apply -f https://raw.githubusercontent.com/kubesphere/kse-installer/v3.3.1-beta.0/deploy/kubesphere-installer.yaml
kubectl apply -f https://raw.githubusercontent.com/kubesphere/kse-installer/v3.3.1-beta.0/deploy/cluster-configuration.yaml
```
