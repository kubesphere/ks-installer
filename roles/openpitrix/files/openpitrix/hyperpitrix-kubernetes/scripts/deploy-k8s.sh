...
DB_SERVICE="mysql.kubesphere-system.svc"
ETCD_SERVICE="etcd.kubesphere-system.svc"
...
busybox_image_new="{{ busybox_repo }}:{{ busybox_tag }}"
busybox_image_old='busybox:1.28.4'
...
replace() {
  sed -e "s!\${NAMESPACE}!${NAMESPACE}!g" \
	  ...
	  -e "s#${busybox_image_old}#${busybox_image_new}#" \
	  $1
}
